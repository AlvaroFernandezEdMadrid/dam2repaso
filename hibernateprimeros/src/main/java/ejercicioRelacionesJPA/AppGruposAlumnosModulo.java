...
public class AppGruposAlumnosModulo {
	...
	static final String UNIDADPERSISTENCIA = "gruposalumnosmodulos";
	...
	public void mostrarAprobados() {
		 ...
		 */
		String query ="SELECT c.alumno FROM Calificacion c "
				+ "WHERE c.modulo.id = ?1 AND "
				+ "c.nota > 4";
	...
	public void subirUnPunto() {
		...
		String query ="UPDATE Calificacion c "
				+ "SET c.nota = c.nota +1 "
				+ "WHERE c.modulo.id = ?1";
	...
	public void eliminarAlumnosGrupo() {
		...
		String query = "DELETE FROM Alumno a "
				+ "WHERE a IN "
