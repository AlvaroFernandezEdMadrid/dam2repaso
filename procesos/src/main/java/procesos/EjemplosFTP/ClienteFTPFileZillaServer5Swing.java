...
public class ClienteFTPFileZillaServer5Swing extends JFrame {
	...
	// constructor
	public ClienteFTPFileZillaServer5Swing() throws IOException {
		super("CLIENTE BÁSICO FTP");		
		System.out.println("Conectándose a " + servidor);
		
		cliente.addProtocolCommandListener(new PrintCommandListener (new PrintWriter (System.out) )); 
		cliente.connect(servidor);
		cliente.enterLocalPassiveMode();//Para máquinas virtuales no deja.
		...
		campo.setText("<<   ÁRBOL DE DIRECTORIOS CONSTRUÍDO    >>");
	...
	private static void llenarLista(FTPFile[] files, String direc2) {
		...
		try {	
			...
			;System.out.println("linea 334 - llega al último");
		}
	}//Fin llenarLista
	...
	public static void main(String[] args) throws IOException {
		new ClienteFTPFileZillaServer5Swing();
	}// FIN main
